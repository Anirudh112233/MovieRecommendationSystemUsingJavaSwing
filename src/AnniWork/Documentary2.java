 ...
 * @author ARP
 */
public class Documentary2 extends javax.swing.JFrame {
    
    private String loggedInEmail;
    
    public JTextArea jTextArea1;
    /**
     * Creates new form Documentary2
     */
    public Documentary2() {
    ...
    setSize(1100, 650); // Set the size of the frame
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Documentary2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Documentary2().setVisible(true);
            }
        });
    }
